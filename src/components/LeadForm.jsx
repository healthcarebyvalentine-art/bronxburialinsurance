...
import { GOOGLE_SCRIPT_URL, BOROUGHS, AGE_RANGES, COVERAGE_AMOUNTS } from '../constants'
...
export default function LeadForm() {
  ...
  const submit = async () => {
    ...
    setStatus('sending')
    try {
      const params = new URLSearchParams({ ...form, source: 'bronx-burial-insurance.com', timestamp: new Date().toISOString() })
